	...
	<div class="themeDashboarMainAreainner">
		...
		<div class="dashPanelBody">
			<div class="digitalCurrencyStep_area">
				...
				<p>Select currency and block network you want to deposit,and copy the deposit address on this page</p>
				</div>
				</li>
				<li>
				<div class="content">
			...
			<p>*Please confirm again that the main network you selected is <strong>BINNANCE SMART CHAIN (BEP20)</strong></p>
			</div>
