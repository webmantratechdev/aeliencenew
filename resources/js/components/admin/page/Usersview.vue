    ...
    <div class="px-5 border-top py-5">
        <div class="row">
                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="country" @change="changeCountry($event)">
                                ...
                                <option v-for="countrys in countryOp" :value="countrys.phonecode"> {{ countrys.name }}
                                </option>
                            </select>
                        </div>
                    </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="upload-options">
                                        <label>
                                            ...
                                            <input type="file" name="aadhar_front" class="image-upload" accept="image/*"
                                                capture="camera" required v-on:change="frontonFileChange">
                                        </label>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="upload-options">
                                        <label>
                                            ...
                                            <input type="file" name="aadhar_back" class="image-upload" accept="image/*"
                                                capture="camera" required v-on:change="backonFileChange">
                                        </label>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12 mt-5">
                <button class="btn btn-outline-warning" @click="updateprofilebyadmin">Update Profile</button>
            </div>
        </div>
