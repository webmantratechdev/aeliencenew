...
<body style="background:#eee;">
    <div style="max-width:700px; margin:auto; background:#fff; display:block; width:100%;">
        ...
        <div style="padding:30px;">
            ...
            <p>Your deposit of {{ $amount }} {{$symbol}} is now available in your Aelince account. Log in to check your balance. Read our FAQs if you are running into problems.</p>
            <p>Risk warning: Cryptocurrency trading is subject to high market risk. Binance will make the best efforts to choose high-quality coins, but will not be responsible for your trading losses. Please trade with caution.</p>
